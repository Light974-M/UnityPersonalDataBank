...
{
    [CustomEditor(typeof(CubeSphereMeshBuilder))]
    public class CubeSphereMeshBuilderEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            Color backgroundColor = Color.white;
            CubeSphereMeshBuilder myTarget = (CubeSphereMeshBuilder)target;
            ...
            EditorGUILayout.BeginVertical("helpBox");
            {
                ...
                GUIContent LevelOfDetailContent = new GUIContent(nameof(myTarget.LevelOfDetail), "if enabled, decrease details of mesh with distance to save ressources");
                myTarget.LevelOfDetail = EditorGUILayout.Toggle(LevelOfDetailContent, myTarget.LevelOfDetail);
            }
