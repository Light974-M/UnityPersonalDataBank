...
{
    [CustomEditor(typeof(TetrahedronMeshBuilder))]
    public class TetrahedronMeshBuilderEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            Color backgroundColor = Color.white;
            TetrahedronMeshBuilder myTarget = (TetrahedronMeshBuilder)target;
            ...
            GUIContent cubeParameterContent = new GUIContent("CUBE PARAMETER", "parameters of cube mesh procedural class");
            EditorGUILayout.LabelField(cubeParameterContent);
