...
public class ThrowerManager : UPDBBehaviour
{
    ...
    /// <summary>
    /// Calcule la direction � tirer pour intercepter une cible en mouvement.
    /// </summary>
    /// <param name="A">Point de d�part du projectile</param>
    ...
    /// <returns>Vecteur direction normalis� de la trajectoire du projectile, ou Vector3.zero si pas de solution</returns>
